BEINGS = {
  ...
  arachno     = { face = 'A'; colour = 'YL'; };
  arch        = { face = 'V'; colour = 'YL'; };
  baron       = { face = 'B'; colour = 'MG'; };
  bruiser     = { face = 'B'; colour = 'RD'; }; -- boss
  cacodemon   = { face = 'O'; colour = 'RD'; };
  captain     = { face = 'h'; colour = 'rd'; };
  ...
  knight      = { face = 'B'; colour = 'yl'; };
  lava_elemental = { face = 'E'; colour = 'YL'; }; -- boss
